...
interface IMonsterVars extends VariableType {
	/**  **/
	['Health']: number;
}
interface IMonsterBehaviors extends Record<string, IBehaviorInstance> {
	['Bullet']: IBulletBehaviorInstance
}
interface IMonster extends ISpriteInstance {
	instVars: IMonsterVars;
	behaviors: IMonsterBehaviors;
}
...
interface IDictionaryPlayFabVars extends VariableType {
	
}
interface IDictionaryPlayFabBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IDictionaryPlayFab extends IDictionaryInstance {
	instVars: IDictionaryPlayFabVars;
	behaviors: IDictionaryPlayFabBehaviors;
}

interface IDictionaryDataVars extends VariableType {
	
}
interface IDictionaryDataBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IDictionaryData extends IDictionaryInstance {
	instVars: IDictionaryDataVars;
...
interface IArrayLeaderboardVars extends VariableType {
	
}
interface IArrayLeaderboardBehaviors extends Record<string, IBehaviorInstance> {
